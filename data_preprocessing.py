...
def csv_to_PytorchData():
  ...
  for dataset in datasets:
      ...
      if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test)) or (not os.path.isfile(processed_data_file_val))or (not os.path.isfile(processed_data_file_resampled_train))):
          ...
          train_resampled_drugs, train_resampled_prots,  train_resampled_Y = list(df['compound_iso_smiles']),list(df['target_sequence']),list(df['affinity'])
          XT = [seq_cat(t, max_seq_len, seq_dict) for t in train_resampled_prots]
          train_resampled_drugs, train_resampled_prots,  train_resampled_Y = np.asarray(train_resampled_drugs), np.asarray(XT), np.asarray(train_resampled_Y)
          ...
          train_resampled_data = TestbedDataset(root='data', dataset=dataset+'_resampled_train', xd=train_resampled_drugs, xt=train_resampled_prots, y=train_resampled_Y,smile_graph=smile_graph)
          ...
          print(processed_data_file_train, ' and ', processed_data_file_test, ' and ', processed_data_file_val, ' are already created')
